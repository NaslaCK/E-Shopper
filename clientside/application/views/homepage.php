...
<head>
    ...
    <title>Home Page | E-Shopper</title>
...
{    
	...
	$.ajax({
		'type' :"POST",
		'url' :"http://localhost/E-Shopper_services/index.php/welcome/showdetails",
		'datatype':"json",
		'data':{name:pk},
		'success':function(data){
			var abc= JSON.parse(data);
