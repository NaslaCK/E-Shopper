...
<head>
    ...
    <title>Edit Sub-Category | E-Shopper</title>
	...
	$.ajax({
		'type' :"POST",
		'url' :"http://localhost/E-Shopper_services/index.php/welcome/viewtblsub",
		'datatype':"json",
		'data':{name:vall},
		'success':function(data){
			...
			for (var i = 0 ; i <=abc.length-1; i++) {
				...
				toAppend+="<tr><td>"+abc[i].pk_int_sub_id+"</td><td>"+abc[i].vchr_sub_name+"</td><td><button type='button' class='btn btn-link' onclick='edit(this.value)' value='"+abc[i].pk_int_sub_id+"'>Edit</button></td><td><button type='button' class='btn btn-link' onclick='del(this.value)' value='"+abc[i].pk_int_sub_id+"'>Delete</button></td></tr>";
			};
...
function edit(subclick)
{
	$.ajax({
		'type' :"POST",
		'url' :"http://localhost/E-Shopper_services/index.php/welcome/editsub",
		'datatype':"json",
		'data':{name:subclick },
		'success':function(data){
			...
			for (var i = 0 ; i <=abc.length-1; i++) {
				...
				toAppend+="<input type='hidden' name='category_id' value='"+abc[i].pk_int_sub_id+"'><input type='text' id='txt1' name='subcategory_name'  id='inputcategory' class='form-control' placeholder='"+abc[i].vchr_sub_name+"'><br><button type='submit' name='sub' class='btn btn-danger'>"+'Update'+"</button>";
			};
			$('#id1').append(toAppend);
		}
	});
...
function del(btnvalue)
{
	...
	$.ajax({
		'type' :"POST",
		'url' :"http://localhost/E-Shopper_services/index.php/welcome/deletesubcategory",
		'data':{name:btnvalue},
		'success':function(data){	
		if(data=="YES"){
			alert("error");
...
<body>
	...
	<section>
    	...
    	<div class="bg">
	    	<div class="row">    		
	    		<div class="col-sm-12">    			   			
					<h2 class="title text-center">Edit <strong>Sub-Category</strong></h2>    			    				    				
					...
					<div class="col-sm-offset-2 col-sm-9">
            				<div class="panel panel-default">
                				<div class="panel-heading" align="center">
                					<span  ><b> Update Sub-Category List</b></span> 
                   				</div>
