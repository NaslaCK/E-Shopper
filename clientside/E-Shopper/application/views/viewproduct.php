...
<head>
    ...
    <title>View Products | E-Shopper</title>
...
function fun3(){
	...
	$.ajax({
		...
		'success':function(data){
			...
			var toAppend="<tr><th>"+'Sl No'+"</th><th>"+'Product Name'+"</th><th>"+'Description'+"</th><th>"+'Price'+"</th><th>"+'selling price'+"</th><th>"+'Quantity'+"</th><th>";
			for (var i = 0 ; i <=abc.length-1; i++) {

				toAppend+="<tr><td>"+abc[i].pk_int_product_id+"</td><td>"+abc[i].vchr_product_name+"</td><td>"+abc[i].vchr_desc+" </td><td>"+abc[i].int_price+"</td><td>"+abc[i].int_selling_price+"</td><td>"+abc[i].int_quantity+"</td></tr> ";
			};
...
<body>
	...
	<section>
    	...
    	<div class="bg">
	    	<div class="row">    		
	    		<div class="col-sm-12">    			   			
					<h2 class="title text-center">View <strong>Products</strong></h2>    			    				    				
