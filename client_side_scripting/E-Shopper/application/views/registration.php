					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="" class="active"><i class="fa fa-lock"></i> Register</a></li>
							</ul>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--login form-->
						...
						<form method="POST" name="regform" action="insertreg">
							...
							<span>
							<input  style="width:15px; height:15px; float:left;" type="checkbox" class="checkbox"> 
