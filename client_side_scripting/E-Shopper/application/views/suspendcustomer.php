...
<head>
    ...
    <title>Suspend Customers | E-Shopper</title>
    ...
    <script>
    	function suspend(suspbtn)
{
	$.ajax({
		'type' :"POST",
		'url' :"http://localhost/E-Shopper_services/index.php/welcome/onclicksuspend",
		'datatype':"json",
		'data':{name:suspbtn},
...
<body>
	...
	<section>
    	...
    	<div class="bg">
	    	<div class="row">    		
	    		<div class="col-sm-12">    			   			
					<h2 class="title text-center">Suspend <strong>Customer</strong></h2>    			    				    				
			...
			<div class="row">  	
	    		<div class="col-sm-12">
					<div class="col-sm-offset-2 col-sm-9">
						...
						<?php
							foreach ($suspendcust as $row) 
							{
								echo"<tr>";
								echo "<td>".$row->pk_int_reg_id."</td><td>".$row->vchr_fname." </td><td>".$row->vchr_lname."</td><td>".$row->vchr_status."</td>";
								echo "<td><button type='submit' class='btn btn-danger' value='".$row->pk_int_reg_id."' onclick='suspend(this.value)'>Suspend</button></td>";
								echo "</tr>";
							}
						?>
						</table>
