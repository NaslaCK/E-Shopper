...
<head>
    ...
    <title>Add Subcategory | E-Shopper</title>
...
<body>
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Add<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
										...
										<li><a href="#" class="active">Sub Category</a></li> 					
	...
	<section>
    	...
    	<div class="bg">
	    	<div class="row">    		
	    		<div class="col-sm-12">    			   			
					<h2 class="title text-center">Add <strong>Sub-Category</strong></h2>    			    				    				
                   				...
                   				<div class="panel-body">
                   					<form class="form-horizontal" role="form" name="" action ="selectcategory" method="post">
                   						<div class="form-group">
                        					...
                        					<div class="col-sm-7">
                        					<select name="fk_int_cat_id"><option>Select Category</option>
                        						<?php
										...
										<div class="form-group">
                        					<label for="inputsubcategory" class="col-sm-5 control-label">Sub-Category Name</label>
                        					<div class="col-sm-7">
                        						<input type="text"id="txt1" name="subcat" class="form-control" id="inputsubcategory" placeholder="Enter subcategory name" required>
                       						</div>
                   						</div>
