    	...
    	function edit(btnvalue)
{
	...
	$.ajax({
		'type' :"POST",
		'url' :"http://localhost/E-Shopper_services/index.php/welcome/edit",
		'datatype':"json",
		'data':{name:btnvalue},
		'success':function(data){
			...
			for (var i = 0 ; i <=abc.length-1; i++) {
				...
				toAppend+="<input type='hidden' name='category_id' value='"+abc[i].pk_int_cat_id+"'><input type='text' id='txt1' name='category_name'  id='inputcategory' class='form-control' placeholder='"+abc[i].vchr_cat_name+"'><br><button type='submit' name='sub' class='btn btn-danger'>"+'Update'+"</button>";
			};
			$('#id1').append(toAppend);
		}
	});
...
function del(btnvalue)
{
	...
	$.ajax({
		'type' :"POST",
		'url' :"http://localhost/E-Shopper_services/index.php/welcome/delete",
		'data':{name:btnvalue},
		'success':function(data){	
		if(data=="YES"){
			alert("error");
...
<body>
	...
	<section>
    	...
    	<div class="bg">
	    	<div class="row">    		
	    		<div class="col-sm-12">    			   			
					<h2 class="title text-center">Edit <strong>Category</strong></h2>    			    				    				
